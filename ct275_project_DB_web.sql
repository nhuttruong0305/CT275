...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 12, 2022 lúc 12:07 PM
...
(5, 'Ghế Euro', 960000, 1, 'Ghế Euro ra đời nhằm mong muốn tạo cảm giác thông thoáng, thoải mái cho người dùng. Thân và phần ngồi cách điệu với nhiều lỗ xen kẻ nhau, tạo sự thông thoáng khi ngồi.', 'xanh nhạt', 'Euro', 'ghe_euro.jpg'),
...
(9, 'Kệ Hobu', 400000, 1, 'Bằng việc tối đa hoá diện tích sử dụng, Kệ Hobu mang lại giải pháp trưng bày và lưu trữ hiệu quả nhưng vẫn tiết kiệm không gian cho gia đình nhỏ của bạn.', 'trắng đen', 'Hobu', 'ke_tv_hobu.jpg'),
(10, 'Kệ đẩy Hobu', 750000, 1, 'Với thiết kế ba tầng, không gian chứa đồ rộng rãi và dễ dàng di chuyển, HOBU Trolley sẽ khiến bạn hài lòng về sự linh hoạt và tiện dụng của mình.', 'đen', 'Hobu', 'ke_day_hobu.jpg'),
