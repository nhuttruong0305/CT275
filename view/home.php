        ...
        <div class="mt-5 container">
            ...
            <div class="row">
                ...
                <div id="hotsale_product_home" class="col-md-4 text-center mb-2 hotsale_product_home">
                    <p class="label_hotsale_home">HOT</p>
                    <a href="" class="d-block">
                        <img src="https://bizweb.dktcdn.net/thumb/large/100/364/402/products/2-8c58547694c647f7a135a53c2892470f-large.jpg?v=1566942153000" alt="">
                    </a>
                    <p class="mt-4">
                        <a href="" style="font-size: 16px; text-decoration: none; color: black;" class="font-weight-bolder">Bàn Aillen</a>
                    </p>
                    <p><a href="" style="font-size: 15px; text-decoration: none; color: rgb(84, 88, 92);">AILLEN</a></p>
