    ...
    <main>
        ...
        <div class="mt-5 container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-6 featured_item_home">
                            <a href="../controller/index.php?action=detail_product&id_product=10" class="d-block">
                                <img src="../admin/upload/ke_day_hobu.jpg" alt="">
                            </a>
                        ...
                        <div class="col-md-4 col-6 featured_item_home">
                            <a href="../controller/index.php?action=detail_product&id_product=7" class="d-block">
                                <img src="../admin/upload/dong_ho_miso_limited.jpg" alt="">
                            </a>
                        ...
                        <div class="col-md-4 col-6 featured_item_home">
                            <a href="../controller/index.php?action=detail_product&id_product=27" class="d-block">
                                <img src="../admin/upload/ke_treo_poplar.jpg" alt="">
                            </a>
            ...
            <div class="row">
                ...
                <div id="hotsale_product_home" class="col-md-4 text-center mb-2 hotsale_product_home">
                    <p class="label_hotsale_home">HOT</p>
