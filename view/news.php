    ...
    <div id="news-content" class="container">
        ...
        <div id="news-body" class="row">
            <div class="col-md-4 col-sm-6 mb-4">
                ...
                <div class="blogs">
                    <a class="news-blog" href="../view/img/news/news-main1.webp">Mẹo bảo quản & vệ sinh các đồ nội thất</a>
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                ...
                <div class="blogs">
                    <a class="news-blog" href="../view/img/news/news-main2.webp">Thư thái trong chính căn hộ của bạn</a>
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                ...
                <div class="blogs">
                    <a class="news-blog" href="../view/img/news/news-main3.webp">Bảo quản đồ gỗ khi độ ẩm không khí cao</a>
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                ...
                <div class="blogs">
                    <a class="news-blog" href="../view/img/news/news-main4.webp">Chọn kích thước bàn ăn như nào cho phù hợp?</a>
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                ...
                <div class="blogs">
                    <a class="news-blog" href="../view/img/news/news-main5.webp">Nhà đẹp không thể thiếu những món decor này?</a>
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                ...
                <div class="blogs">
                    <a class="news-blog" href="../view/img/news/news-main6.webp">Có nên dùng gỗ công nghiệp cho đồ nội thất ?</a>
